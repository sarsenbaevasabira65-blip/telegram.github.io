...
# ========================
BOT_TOKEN     = Done! Congratulations on your new bot. You will find it at t.me/Akarissbot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

Use this token to access the HTTP API:
8754227384:AAFlaA-7Bq6wVR8wVAOZqUwY86bCjJuJG4k
Keep your token secure and store it safely, it can be used by anyone to control your bot.

For a description of the Bot API, see this page: https://core.telegram.org/bots/api""   # @BotFather-дан алыңыз
ADMIN_ID      =tel:1313252587                  # Сіздің Telegram ID (@userinfobot)

BUSINESS_NAME = "Сенің идеяң — біздің өнер 🎨"

# Төлем деректері
KASPI_NUMBER  = "+7 7474513371"          # Kaspi нөміріңіз
KASPI_NAME    = "Сабира С"            # Kaspi есімдеріңіз
CARD_NUMBER   = "0000 0000 0000 0000"       # Банк картасы нөмірі
CARD_BANK     = "Halyk / Forte / т.б."     # Банк атауы
