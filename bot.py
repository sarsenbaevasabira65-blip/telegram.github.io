...
# ========================
BOT_TOKEN     = "СІЗДІҢ_BOT_TOKEN_МҰНДА"   # @BotFather-дан алыңыз
ADMIN_ID      = 123456789                   # Сіздің Telegram ID (@userinfobot)

BUSINESS_NAME = "Сенің идеяң — біздің өнер 🎨"

# Төлем деректері
KASPI_NUMBER  = "+7 700 000 00 00"          # Kaspi нөміріңіз
KASPI_NAME    = "Сіздің Атыңыз"            # Kaspi есімдеріңіз
